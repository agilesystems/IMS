...
public class ProductController implements Initializable {
    ...
    public void tableList() {
        try {
            ...
            String[] columns = {"id", "name", "barcode", "salprice", "buyprice", "globalcode", "localcode", "lowestprice",
                "lowestquantity", "expiredate", "extrainfo"};
            tableView.getItems().clear();
            Helper.setTableColumns(list, tableView, columns);
        } catch (Exception e) {
